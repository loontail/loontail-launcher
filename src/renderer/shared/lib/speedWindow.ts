// The launcher's only byte-rate implementation: install, repair and bundle
// progress all display a rate derived here from the cumulative byte counter the
// progress events already carry. `sample` takes a cumulative byte count and
